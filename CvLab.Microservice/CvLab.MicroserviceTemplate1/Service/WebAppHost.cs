...
using CvLab.MicroserviceTemplate1.Controllers;
...
namespace CvLab.MicroserviceTemplate1.Service
{
    internal class WebAppHost : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            _webHost = webHostBuilder
                ...
                .ConfigureServices((ctx, services) =>
                {
                    ...
                    services.AddSwaggerGen(c =>
                    {
                        ...
                        {
                            Title = "CvLab.MicroserviceTemplate1 API",
                            Version = "v1",
                            Description = "CvLab.MicroserviceTemplate1"
                        });
                    });
                ...
                .Configure(app =>
                {
                    ...
                    app.UseSwaggerUI(c =>
                    {
                        c.SwaggerEndpoint("/swagger/v1/swagger.json", "CvLab.MicroserviceTemplate1 API V1");
                    });
            ...
            LogTo.Information("WebHost CvLab.MicroserviceTemplate1 starting at {WebHostPort}", servicePort);
